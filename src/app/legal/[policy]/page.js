...
const policiesData = {
    terms: {
        ...
        content: [
            ...
            'Participation fees of ₹6,999 INR + GST (if applicable) are required to complete the registration process. This fee covers administrative overheads, screening expenses, and primary shortlisting logs.',
    ...
    refund: {
        ...
        content: [
            'The registration processing fee of ₹6,999 + GST is used immediately to cover panel screening, database slots, profile processing, and digital review resources.',
            ...
            'To request a duplicate payment refund review, contact support at nintmofficial@gmail.com with your transaction receipt, Registration ID, and payment gateway references.'
        ]
    },
    cancellation: {
